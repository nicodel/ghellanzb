...
p = Py2deb(ghellanzb.unix_name + '-xfce')
p.depends = 'python-gtk2, python, hellanzb, xfce4-xfapplet-plugin'
...
p['/usr/bin'] = ['ghellanzb/ghellanzb_applet.py|ghellanzb']
...
p.generate(ghellanzb.version, changelog, src = False)
